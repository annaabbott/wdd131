...
selectFluxCapacitor.innerText = products[0].name.charAt(0).toUpperCase()+ products[0].name.slice(1);
...
selectPowerLaces.innerText = products[1].name.charAt(0).toUpperCase()+ products[1].name.slice(1);
...
selectTimeCircuits.innerText = products[2].name.charAt(0).toUpperCase()+ products[2].name.slice(1);
...
selectLowVoltageReactor.innerText = products[3].name.charAt(0).toUpperCase()+ products[3].name.slice(1);
